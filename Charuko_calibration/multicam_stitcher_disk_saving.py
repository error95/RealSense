...
from hand_eye_calibration import CameraRobotCalibration
...
def main():
    ...
    charuco_board_robot = aruco.CharucoBoard_create(charuco_width_r, charuco_height_r, square_length_r, marker_length_r, aruco_dict_r)
    ...
    charuco_board_robot_2 = aruco.CharucoBoard_create(charuco_width_ro, charuco_height_ro, square_length_ro, marker_length_ro,
                                                    aruco_dict_ro)
    ...
    while True:
        ...
        if visualisation == '1':
            ...
            robot_calibration = CameraRobotCalibration(transformation_devices, device_manager, charuco_board_robot_2, charuco_board_robot)
